...
export default function YourPregnancyMassageClient() {
  ...
  return (
    <>
      ...
      <main style={{ background: '#000000' }}>
        <div
          ref={heroRef}
          className={`${styles.hero} ypm-hero-block`}
          style={{
            position: 'sticky',
        ...
        >
          ...
          <div className={styles.heroContent} style={{ zIndex: 10, paddingRight: 0, maxWidth: 'none' }}>
            <h1 className={styles.heroH1}>Your Pregnancy Massage</h1>
            ...
            <div className={styles.serviceGrid}>
              <div>
                ...
                <ul style={{ listStyle: 'disc', paddingLeft: 28, marginLeft: 8 }}>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Relieves lower back and hip pain</li>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Reduces swelling in hands and feet</li>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Eases sciatic nerve discomfort</li>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Reduces pregnancy-related anxiety</li>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Improves sleep quality</li>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Supports emotional wellbeing throughout pregnancy</li>
                </ul>
              </div>
              <div>
                <h3 style={{ fontSize: '1.2rem', fontWeight: 600, textTransform: 'none', letterSpacing: '0.04em', color: '#ffffff', marginBottom: 20, lineHeight: 1.3 }}>
                ...
                <ul style={{ listStyle: 'disc', paddingLeft: 28, marginLeft: 8 }}>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Women in their second or third trimester</li>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Those experiencing back or hip pain in pregnancy</li>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Pregnant women with swelling or oedema</li>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Anyone feeling anxious or stressed during pregnancy</li>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Those who want regular wellness support</li>
                  <li style={{ fontSize: '0.98rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.3, marginBottom: 8 }}>Women seeking safe, specialist prenatal care</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <style>{`
        .ypm-hero-img-desktop { display: none; }
        @media (min-width: 1025px) {
          .ypm-hero-img-mobile { display: none !important; }
          .ypm-hero-img-desktop { display: block !important; }
        }
