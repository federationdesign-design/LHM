...
const staticRoutes: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency'] }[] = [
  ...
  { path: '/corporate/dsc-assessments',  priority: 0.6, changeFrequency: 'monthly' },
  { path: '/corporate/in-chair-massage', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/corporate/posture-consultations', priority: 0.6, changeFrequency: 'monthly' },
