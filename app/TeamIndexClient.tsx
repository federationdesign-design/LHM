...
const members = [
  ...
  },
  {
    ...
    location: 'Thoday Street',
    locationSlug: 'thoday-street',
    photo: '/orla-profile-img.jpg',
    treatments: ['Sports Therapy', 'Sports Massage', 'Cupping', 'Dry Needling', 'Deep Tissue Massage'],
    bio: 'Orla is an experienced Sports Therapist and massage therapist based at our Thoday Street clinic in Cambridge. She holds a BSc (Hons) degree in Sports Therapy and specialises in sports therapy, sports massage, cupping therapy, dry needling, and deep tissue massage, bringing a focused, clinical, and results-driven approach to every treatment. Orla also works pitch side with local rugby club Cantabs RFC, supporting players with injury management, recovery, and performance. She is insured by the Society of Sports Therapists.',
    corporate: false,
  },
  {
    slug: 'lucy-hall',
        ...
        <div className="team-grid">
          {displayTeam.map((m) => (
            <div key={m.slug} className="team-card">
              ...
              {/* Profile photo + name — always clickable, links to /team/[slug] */}
