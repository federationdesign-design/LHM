...
export const metadata: Metadata = {
  ...
  description:
    'Corporate massage services in Cambridge. In-office chair massage, DSE assessments, and posture consultations to support employee wellbeing and reduce sickness and absenteeism at work.',
  alternates: {
