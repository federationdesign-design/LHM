...
function BookingWidget({ service }: { service: Service }) {
      ...
      if (typeof (window as any).SimplybookWidget !== 'undefined') {
        new (window as any).SimplybookWidget({
          ...
          theme_settings: {
            ...
            dark_font_color: '#ffffff', btn_color_1: '#2cd12c',
          ...
          app_config: {
            ...
            predefined: { service: service.widgetService, location: service.widgetLocation },
          },
  ...
  }, [service.widgetService, service.widgetLocation, widgetId]);
...
function Testimonials() {
  ...
  return (
    <section className={styles.testimonialsSection}>
      ...
      <div className={animate ? styles.testimonialsTrack : styles.testimonialsTrackNoAnim}
      ...
      <main className={styles.page}>
        ...
        <div ref={heroRef} className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            <h1 className={styles.heroH1}>{service.h1}</h1>
        ...
        <footer className={styles.footer}>
          ...
          <div className={styles.footerHours}>
            Monday &nbsp;&nbsp;&nbsp;~ 9am to 8pm<br />Tuesday &nbsp;&nbsp;~ 9am to 8pm<br />Wednesday ~ 9am to 8pm<br />Thursday &nbsp;~ 9am to 8pm<br />Friday &nbsp;&nbsp;&nbsp;&nbsp;~ 9am to 6pm<br />Saturday &nbsp;~ 9am to 5.30pm<br />Sunday &nbsp;&nbsp;&nbsp;~ 10am to 5pm
          </div>
          <div className={styles.footerGrid}>
            <div className={styles.footerCol}><h4>Lucy Hall Massage Therapy</h4><p style={{ fontSize: '0.82rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.6 }}>2 Antwerp Cottages,<br />Thoday Street,<br />Cambridge, CB1 3AU<br /><a href="tel:07765555078" style={{ textDecoration: 'underline' }}>07765 555078</a><br /><a href="https://maps.google.com" target="_blank" rel="noopener" style={{ textDecoration: 'underline' }}>Google map</a></p></div>
            <div className={styles.footerCol}><h4>Main Menu</h4><ul>{['Homepage', 'Book online', 'Treatments', 'About', 'News', 'Contact', 'Testimonials', 'Gift Vouchers'].map(i => <li key={i}><a href="#">{i}</a></li>)}</ul></div>
            <div className={styles.footerCol}><h4>Useful Links</h4><ul>{['FAQ', 'Facebook', 'Instagram', 'LinkedIn', 'SOP', 'Privacy Policy', 'Terms of Use', 'Receipts'].map(i => <li key={i}><a href="#">{i}</a></li>)}</ul></div>
            <div className={styles.footerCol}><h4>Treatments</h4><ul>{['Deep Tissue', 'Massage', 'Hopi Ear', 'Physiotherapy', 'Pregnancy', 'Relaxation', 'Sports Massage', 'Swedish'].map(i => <li key={i}><a href="#">{i}</a></li>)}</ul></div>
            <div className={styles.footerCol}><h4>Opening Times</h4><p style={{ fontSize: '0.82rem', color: '#ffffff', fontWeight: 300, lineHeight: 1.9 }}>Monday &nbsp;&nbsp;– 9am to 8pm<br />Tuesday &nbsp;– 9am to 8pm<br />Wednesday – 9am to 8pm<br />Thursday – 9am to 8pm<br />Friday &nbsp;&nbsp;&nbsp;– 9am to 6pm<br />Saturday – 9am to 5.30pm<br />Sunday &nbsp;&nbsp;– 10am to 5pm</p></div>
          </div>
