...
const slides = [
  { type: 'intro' as const, slug: 'intro', title: null, tagline: null, image: null, color: '#000000', cta: null, ctaHref: null },
  {
    ...
    image: '/60-min-portrait.jpg', color: '#835e41', cta: 'Book Now', ctaHref: '/treatments/60-min-massage#booking-widget',
  },
  {
    ...
    image: '/90-min-portrait.jpg', color: '#8a7d68', cta: 'Book Now', ctaHref: '/treatments/90-min-massage#booking-widget',
  },
  {
    ...
    image: '/120-min-portrait.jpg', color: '#938d90', cta: 'Book Now', ctaHref: '/treatments/120-min-massage#booking-widget',
  },
  {
    ...
    image: '/deep-tissue-portrait.jpg', color: '#4e3225', cta: 'Book Now', ctaHref: '/treatments/deep-tissue-massage#booking-widget',
  },
  {
    ...
    image: '/swedish-portrait.jpg', color: '#cb8f77', cta: 'Book Now', ctaHref: '/treatments/swedish-massage#booking-widget',
  },
  {
    ...
    image: '/sports-portrait.jpg', color: '#d09f7e', cta: 'Book Now', ctaHref: '/treatments/sports-massage#booking-widget',
  },
  {
    ...
    image: '/relaxation-portrait.jpg', color: '#eab7a4', cta: 'Book Now', ctaHref: '/treatments/relaxation-massage#booking-widget',
  },
  {
    ...
    image: '/pregnancy-portrait.jpg', color: '#548661', cta: 'Book Now', ctaHref: '/your-pregnancy-massage#booking-widget',
  },
  {
    ...
    image: '/hopi-portrait.jpg', color: '#d57640', cta: 'Book Now', ctaHref: '/treatments/hopi-ear#booking-widget',
  },
  {
    ...
    image: '/sports-therapy-portrait-new.jpg', color: '#b46a51', cta: 'Book Now', ctaHref: '/treatments/sports-therapy#booking-widget',
  },
  {
    ...
    image: '/head-massage-portrait.jpg', color: '#eab7a4', cta: 'Book Now', ctaHref: '/treatments/indian-head-massage#booking-widget',
  },
  {
    ...
    image: '/hot-stone-massage-portrait.jpg', color: '#d09f7e', cta: 'Book Now', ctaHref: '/treatments/hot-stone-massage#booking-widget',
  },
  {
    ...
    image: '/cupping-portrait.jpg', color: '#cb8f77', cta: 'Book Now', ctaHref: '/your-cupping-massage#booking-widget',
  },
...
function MobileTreatments() {
  ...
  return (
    <div
      ref={wrapperRef}
      style={{ position: 'relative', height: 'calc(100dvh - 56px)', overflow: 'hidden', background: '#000000', touchAction: 'pan-x', overscrollBehavior: 'contain' }}
    >
      <style>{`
          ...
          >
            {slide.type === 'intro' ? (
              <div style={{ position: 'absolute', inset: 0, background: '#000000', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '40px 28px 60px', overflowY: 'auto' }}>
                ...
                <h1 style={{ fontSize: '2rem', fontWeight: 600, color: '#ffffff', lineHeight: 1.1, marginBottom: 8 }}>All Treatments</h1>
