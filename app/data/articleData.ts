// app/data/articleData.ts
// Pure data exports for blog articles - no Node.js imports.
// Safe to import from client components.
// blog.ts re-exports from here and adds fs-using helpers.
...
export const articles: Record<string, BlogArticle> = {
  ...
  'the-benefits-of-dry-needling': {
    ...
    relatedTreatments: ['sports-therapy', 'sports-massage', 'deep-tissue-massage'],
  ...
  'what-is-physiotherapy': {
    ...
    relatedTreatments: ['sports-therapy'],
  ...
  'gait-analysis-101': {
    ...
    relatedTreatments: ['sports-therapy', 'sports-massage'],
  ...
  'beating-back-pain-in-the-workplace': {
    ...
    relatedTreatments: ['deep-tissue-massage', 'sports-therapy', 'sports-massage'],
