...
export const services: Record<string, Service> = {
  ...
  'deep-tissue-massage': {
    ...
    tagline: 'Book your appointment in just two minutes with our simple online booking system.',
    heroMobile: '/deep-tissue-portrait.jpg',
    heroDesktop: '/deep-tissue-landscape.jpg',
    heroColor: '#4e3225',
  ...
  'swedish-massage': {
    ...
    h1: 'Swedish Massage',
    tagline: 'Book your appointment in just two minutes with our simple online booking system.',
    heroMobile: '/swedish-portrait.jpg',
    heroDesktop: '/swedish-landscape.jpg',
    heroColor: '#806b69',
  ...
  'pregnancy-massage': {
    ...
    tagline: 'Book your appointment in just two minutes with our simple online booking system.',
    heroMobile: '/pregnancy-portrait.jpg',
    heroDesktop: '/pregnancy-landscape.jpg',
    heroColor: '#8a9292',
  ...
  '90-min-pregnancy-massage-preview': {
    slug: '90-min-pregnancy-massage-preview',
    title: '90 Minute Pregnancy Massage',
    h1: '90 Minute Pregnancy Massage',
    tagline: 'Book your appointment in just two minutes with our simple online booking system.',
    heroMobile: '/pregnancy-portrait.jpg',
    ...
    metaDescription: 'Book a 90 minute pregnancy massage in Cambridge with Lucy Hall Massage Therapy. Extended specialist treatment for back pain, swelling and stress during pregnancy. Book online in 2 minutes.',
    keywords: ['90 minute pregnancy massage cambridge', 'prenatal massage cambridge', 'massage during pregnancy cambridge', 'maternity massage cambridge'],
    canonicalUrl: 'https://www.lucyhallmassage.com/treatments/90-min-pregnancy-massage-preview/',
    widgetService: '18',
    widgetLocation: '4',
    intro: 'Pregnancy massage is a specially adapted treatment designed to support the physical and emotional changes of pregnancy. Using gentle, safe techniques our therapists help relieve common discomforts including back pain, swelling and fatigue, providing both physical relief and a much-needed moment of calm during this special time.',
    benefits: [
  ...
  'hopi-ear': {
    ...
    tagline: 'Book your appointment in just two minutes with our simple online booking system.',
    heroMobile: '/hopi-portrait.jpg',
    heroDesktop: '/hopi-landscape.jpg',
    heroColor: '#d57640',
  ...
  'indian-head-massage': {
    ...
    tagline: 'Book your appointment in just two minutes with our simple online booking system.',
    heroMobile: '/head-massage-portrait.jpg',
    heroDesktop: '/head-massage-landscape.jpg',
    heroColor: '#207d55',
  ...
  'hot-stone-massage': {
    ...
    tagline: 'Book your appointment in just two minutes with our simple online booking system.',
    heroMobile: '/hot-stone-massage-portrait.jpg',
    heroDesktop: '/hot-stone-massage-landscape.jpg',
    heroColor: '#977b6b',
  ...
  'cupping': {
    ...
    h1: 'Cupping Therapy',
    tagline: 'Book your appointment in just two minutes with our simple online booking system.',
    heroMobile: '/cupping-60-portrait.jpg',
    heroDesktop: '/cupping-60-landscape.jpg',
    heroColor: '#725438',
  ...
  '90-min-cupping': {
    slug: '90-min-cupping',
    title: '90 Minute Cupping',
    h1: '90 Minute Cupping Therapy',
    tagline: 'Book your appointment in just two minutes with our simple online booking system.',
    heroMobile: '/cupping-90-portrait.jpg',
    heroDesktop: '/cupping-90-landscape.jpg',
    heroColor: '#725438',
    metaTitle: '90 Minute Cupping Therapy Cambridge | Lucy Hall Massage Therapy',
    metaDescription: 'Book a 90 minute cupping therapy session in Cambridge with Lucy Hall Massage Therapy. Extended fascial release for deep, stubborn tension across multiple areas. Book online in 2 minutes.',
  ...
  'sports-therapy': {
    ...
    h1: 'Sports Therapy',
    tagline: 'Book your appointment in just two minutes with our simple online booking system.',
    heroMobile: '/sports-therapy-portrait-new.jpg',
    heroDesktop: '/sports-therapy-landscape-new.jpg',
    heroColor: '#8e3f49',
