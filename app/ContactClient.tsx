                ...
                <div style={{ marginLeft: 40 }}>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    {[
                      ...
                      { href: 'https://www.linkedin.com/in/lucy-hall-47369141/', label: 'LinkedIn', icon: <svg viewBox="0 0 24 24" fill="#ffffff" style={{ width: 20, height: 20 }}><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg> },
                    ].filter(({ label }) => variant === 'corporate' ? label === 'LinkedIn' : label !== 'LinkedIn').map(({ href, label, icon }) => (
